...
const trunks: Trunk[] = [
    { id: 'trunk-1', name: 'Opérateur Principal', domain: 'sip.provider.com', login: 'user12345' },
    { id: 'trunk-2', name: 'Opérateur Secondaire', domain: 'sip.another.fr', login: 'user67890' }
];
