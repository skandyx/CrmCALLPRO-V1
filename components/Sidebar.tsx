...
import type { Feature, FeatureId, User, FeatureCategory } from '../types.ts';
import {
...
const Sidebar: React.FC<SidebarProps> = ({ features, activeFeatureId, onSelectFeature, currentUser, onLogout }) => {
